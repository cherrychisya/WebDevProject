...
<head>
  ...
  <script>
    function validateForm() {
      ...
      var confirmPassword = document.getElementById("yourConfirmPassword").value;
  ...
  <main>
    <div class="container">
      <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
          <form  form action="db-register.php?usertype=admin'" method="post" onsubmit="return validateForm()">
